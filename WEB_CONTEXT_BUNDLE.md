...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GUY-A18"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-v1",
      "problem_contract_sha256": "672bf500c77e5ad2a2d0c91a6d3debd19669a4e1a2a337ef0c8d216e28de0e97",
      "problem_id": "problem:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469",
      "route_id": "route:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-source-fidelity-01",
      "graph_id": "graph:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "In the Erdős-Selfridge classification of primes, are there infinitely many primes in each class? Prime $p$ is in class 1 if the only prime divisors of $p+1$ are 2 or 3; and $p$ is in class $r$ if every prime factor of $p+1$ is in some class $\\le r-1$, with equality for at least one prime factor."
          },
          "statement_sha256": "08636435bcb5637d05e1fe5583f4d28a03ea87b43ca43fe07392c80d8c6092a0"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-root",
      "route_id": "route:um-guy-a18-erd-s-selfridge-classification-infinit-7c37c469-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-guy-a18-0f7e3d815373",
        "url": "https://www.unsolvedmath.com/problems/GUY-A18"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
